...
fn test_bt2408_overrun_peak_1_000() {
    ...
    let pq_ootf = Bt2408ToneMapper::new(0.1);
...
fn test_bt2408_overrun_peak_4_000() {
    ...
    let pq_ootf = Bt2408ToneMapper::new(0.4);
...
fn test_bt2408_overrun_peak_10_000() {
    ...
    let pq_ootf = Bt2408ToneMapper::new(1.0);
...
fn test_bt2408_ootf_peak_2000() {
    ...
    let pq_ootf = Bt2408ToneMapper::new(0.2);
...
fn test_bt2408_ootf_peak_8000() {
    ...
    let pq_ootf = Bt2408ToneMapper::new(0.8);
