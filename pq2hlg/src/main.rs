...
fn main() {
    ...
    let matches = app_from_crate!()
        ...
        .arg(Arg::with_name("hlg-compensate")
            .long("hlg-compensate")
            .short("c")
            .help("Enables HLG oversaturation compensation")
            .takes_value(false)
    ...
    let hlg_compensate = matches.is_present("hlg-compensate");
    ...
    header.push(format!("hlg-compensate: {}", hlg_compensate));
